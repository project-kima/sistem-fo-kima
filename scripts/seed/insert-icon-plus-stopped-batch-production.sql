-- ============================================================================
-- UPSERT DATA CUSTOMER BERHENTI PT INDONESIA COMNETS PLUS (ICON+) - PRODUCTION
-- ============================================================================
-- Tanggal: 2026-05-17
...
-- - Semua paket 1/32 dimasukkan sebagai sharing_core.
...
BEGIN
  ...
  FOR row_data IN
    SELECT *
    FROM (VALUES
      ('CUST-ICON-ANUGERAH-PHARMINDO-LESTARI', 'PT Anugerah Pharmindo Lestari', DATE '2021-12-20', DATE '2021-12-20', DATE '2022-12-19', 'sharing_core', 0, '1/32', '-', '014/INV.FO/IV/2022', 'lunas', 250000::numeric, 3000000::numeric, 2500000::numeric, 12, 'Berhenti'),
      ('CUST-ICON-ANUGERAH-PHARMINDO-LESTARI', 'PT Anugerah Pharmindo Lestari', DATE '2021-12-20', DATE '2022-12-20', DATE '2023-12-19', 'sharing_core', 0, '1/32', 'NO-BAK-ICON-ANUGERAH-PHARMINDO-2022', '097/INV.FO/III/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-ICON-INDOMARCO-PRISMATAMA-STOPPED', 'PT Indomarco Prismatama', DATE '2022-11-09', DATE '2022-11-09', DATE '2023-11-08', 'sharing_core', 0, '1/32', '-', '087/INV.FO/I/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-ICON-OLAM-INDONESIA', 'PT Olam Indonesia', DATE '2022-09-24', DATE '2022-09-24', DATE '2023-09-23', 'sharing_core', 0, '1/32', '-', '073/INV.FO/XII/2022', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-ICON-INDOFOOD-CBP-SUKSES-MAKMUR-STOPPED', 'PT Indofood CBP Sukses Makmur', DATE '2022-09-30', DATE '2022-09-30', DATE '2023-09-29', 'sharing_core', 0, '1/32', '-', '074/INV.FO/XII/2022', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-ICON-INDOFOOD-CBP-SUKSES-MAKMUR-STOPPED', 'PT Indofood CBP Sukses Makmur', DATE '2022-09-30', DATE '2023-09-30', DATE '2024-09-29', 'sharing_core', 0, '1/32', 'KIMA.BAK-38/DBO/FO/VIII/2024', '183/INV.FO/XI/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-ICON-INDOFOOD-CBP-SUKSES-MAKMUR-STOPPED', 'PT Indofood CBP Sukses Makmur', DATE '2022-09-30', DATE '2024-09-30', DATE '2025-09-29', 'sharing_core', 0, '1/32', 'SP2K No. 4500023787', 'INV-004/KIMA/FO/I/2025', 'lunas', 275000::numeric, 3300000::numeric, NULL::numeric, 12, 'Berhenti')
  ...
  LOOP
    ...
    IF v_customer_id IS NULL THEN
      ...
      VALUES (row_data.customer_code, 'PT Indonesia Comnets Plus', row_data.customer_name, 'berhenti', COALESCE(row_data.activation_fee_amount, 0), row_data.cooperation_start_date, NOW(), NOW())
...
WHERE c.customer_code IN (
  'CUST-ICON-ANUGERAH-PHARMINDO-LESTARI',
  'CUST-ICON-INDOMARCO-PRISMATAMA-STOPPED',
  'CUST-ICON-OLAM-INDONESIA',
  'CUST-ICON-INDOFOOD-CBP-SUKSES-MAKMUR-STOPPED'
)
