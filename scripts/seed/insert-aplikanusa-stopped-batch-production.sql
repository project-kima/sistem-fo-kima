-- ============================================================================
-- UPSERT DATA CUSTOMER BERHENTI PT APLIKANUSA LINTASARTA - PRODUCTION
-- ============================================================================
-- Tanggal: 2026-05-17
...
-- - Nomor BAK '-' atau kosong memakai nomor teknis NO-BAK-*.
-- - Nomor invoice kosong memakai seed teknis customer_code.
...
BEGIN
  ...
  FOR row_data IN
    SELECT *
    FROM (VALUES
      ('CUST-APL-ANUGERAH-PHARMINDO-LESTARI-1-STOPPED', 'PT Anugerah Pharmindo Lestari 1', DATE '2023-03-25', DATE '2023-03-25', DATE '2024-03-24', 'sharing_core', 0, '1/32', 'KIMA.BAK-06/DBO/FO/III/2023', '101/INV.FO/IV/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-APL-ANUGERAH-PHARMINDO-LESTARI-1-STOPPED', 'PT Anugerah Pharmindo Lestari 1', DATE '2023-03-25', DATE '2024-03-25', DATE '2025-03-24', 'sharing_core', 0, '1/32', 'KIMA.BAK-30/DBO/FO/VI/2024', 'INV-057/KIMA/FO/VII/2024', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-APL-ANUGERAH-PHARMINDO-LESTARI-1-STOPPED', 'PT Anugerah Pharmindo Lestari 1', DATE '2023-03-25', DATE '2025-03-25', DATE '2026-03-24', 'sharing_core', 0, '1/32', 'KIMA.BAK-38/DBO/FO/VIII/2025', '097/FO/11/25', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-KAMADJAJA-LOGISTICS-1-STOPPED', 'PT Kamadjaja Logistics 1', DATE '2023-10-15', DATE '2023-10-15', DATE '2024-10-14', 'sharing_core', 0, '1/16', 'KIMA.BAK-35/DBO/FO/VI/2024', 'INV-062/KIMA/FO/VII/2024', 'lunas', 500000::numeric, 6000000::numeric, 2500000::numeric, 12, 'Berhenti'),

      ('CUST-APL-ENSEVAL-PUTRA-MEGATRADING-STOPPED', 'PT Enseval Putra Megatrading', DATE '2023-04-29', DATE '2023-04-29', DATE '2024-04-28', 'sharing_core', 0, '1/32', 'KIMA.BAK-12/DBO/FO/III/2023', '107/INV.FO/IV/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-APL-ENSEVAL-PUTRA-MEGATRADING-STOPPED', 'PT Enseval Putra Megatrading Tbk', DATE '2023-04-29', DATE '2024-04-29', DATE '2025-04-28', 'sharing_core', 0, '1/32', 'KIMA.BAK-33/DBO/FO/VI/2024', 'INV-060/KIMA/FO/VII/2024', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-INDOARSIP-KERTAS-KARYA-STOPPED', 'PT Indoarsip Kertas Karya', DATE '2023-02-16', DATE '2023-02-16', DATE '2024-02-15', 'sharing_core', 0, '1/32', 'KIMA.BAK-02/DBO/FO/II/2023', '093/INV.FO/II/2023', 'lunas', 250000::numeric, 3000000::numeric, 1500000::numeric, 12, 'Berhenti'),

      ('CUST-APL-ANUGERAH-PHARMINDO-LESTARI-2-STOPPED', 'PT Anugerah Pharmindo Lestari 2', DATE '2023-03-25', DATE '2023-03-25', DATE '2024-03-24', 'sharing_core', 0, '1/32', 'KIMA.BAK-07/DBO/FO/III/2023', '102/INV.FO/IV/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-CARGILL-INDONESIA-STOPPED', 'PT Cargill Indonesia', DATE '2022-07-08', DATE '2022-07-08', DATE '2023-07-07', 'sharing_core', 0, '1/32', '-', '076/INV.FO/XII/2022', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),
      ('CUST-APL-CARGILL-INDONESIA-STOPPED', 'PT Cargill Indonesia', DATE '2022-07-08', DATE '2023-07-08', DATE '2024-07-07', 'sharing_core', 0, '1/32', 'KIMA.BAK-29/DBO/FO/VI/2023', '156/INV.FO/VII/2023', 'lunas', 250000::numeric, 3000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-CHAROEN-POKPHAND-INDONESIA-STOPPED', 'PT Charoen Pokphand Indonesia', DATE '2023-03-15', DATE '2023-03-15', DATE '2024-03-14', 'sharing_core', 0, '1/16', 'KIMA.BAK-11/DBO/FO/III/2023', '106/INV.FO/IV/2023', 'lunas', 500000::numeric, 6000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-MARS-SYMBIOSCIENCE-INDONESIA-1-STOPPED', 'PT Mars Symbioscience Indonesia 1', DATE '2023-03-13', DATE '2023-03-13', DATE '2024-03-12', 'sharing_core', 0, '1/16', 'KIMA.BAK-08/DBO/FO/III/2023', '103/INV.FO/IV/2023', 'lunas', 500000::numeric, 6000000::numeric, NULL::numeric, 12, 'Berhenti'),

      ('CUST-APL-MERAPI-UTAMA-PHARMA-STOPPED', 'PT Merapi Utama Pharma', DATE '2022-03-15', DATE '2022-03-15', DATE '2023-03-14', 'sharing_core', 0, '1/16', '-', NULL, 'lunas', 500000::numeric, 6000000::numeric, NULL::numeric, 12, 'Berhenti')
  ...
  LOOP
    ...
    v_invoice_seed := CASE
      WHEN row_data.invoice_seed IS NULL OR trim(row_data.invoice_seed) = '' OR row_data.invoice_seed = '-'
        THEN row_data.customer_code
      ELSE row_data.invoice_seed
    END;
    ...
    IF v_customer_id IS NULL THEN
      ...
      VALUES (row_data.customer_code, 'PT Aplikanusa Lintasarta', row_data.customer_name, 'berhenti', COALESCE(row_data.activation_fee_amount, 0), row_data.cooperation_start_date, NOW(), NOW())
    ...
    FOR v_month_index IN 0..(row_data.invoice_count - 1) LOOP
      ...
      v_invoice_number := v_invoice_seed || '-' || to_char(v_period_start, 'YYYYMM');
...
WHERE c.customer_code IN (
  'CUST-APL-ANUGERAH-PHARMINDO-LESTARI-1-STOPPED',
  'CUST-APL-KAMADJAJA-LOGISTICS-1-STOPPED',
  'CUST-APL-ENSEVAL-PUTRA-MEGATRADING-STOPPED',
  'CUST-APL-INDOARSIP-KERTAS-KARYA-STOPPED',
  'CUST-APL-ANUGERAH-PHARMINDO-LESTARI-2-STOPPED',
  'CUST-APL-CARGILL-INDONESIA-STOPPED',
  'CUST-APL-CHAROEN-POKPHAND-INDONESIA-STOPPED',
  'CUST-APL-MARS-SYMBIOSCIENCE-INDONESIA-1-STOPPED',
  'CUST-APL-MERAPI-UTAMA-PHARMA-STOPPED'
)
