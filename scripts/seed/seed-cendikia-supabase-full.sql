...
BEGIN
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_btn_customer_id, 'KIMA.BAK-42/DBO/FO/IX/2023', '2023-07-08', '2024-07-07', 'sharing_core', 0, '1/32', 'expired', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_btn_customer_id, 1, '2023-07-08', '2024-07-07', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_btn_customer_id, 'KIMA.BAK-38/DBO/FO/VI/2024', '2024-07-08', '2025-07-07', 'sharing_core', 0, '1/32', 'expired', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_btn_customer_id, 1, '2024-07-08', '2025-07-07', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_btn_customer_id, 'KIMA-BAK-32/DBO/FO/VII/2025', '2025-07-08', '2026-07-07', 'sharing_core', 0, '1/32', 'aktif', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_btn_customer_id, 1, '2025-07-08', '2026-07-07', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_wastec_customer_id, 'KIMA.BAK-43/DBO/FO/IX/2023', '2023-08-18', '2024-08-17', 'sharing_core', 0, '1/32', 'expired', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_wastec_customer_id, 1, '2023-08-18', '2024-08-17', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_wastec_customer_id, 'KIMA.BAK-54/DBO/FO/IX/2024', '2024-08-18', '2025-08-17', 'sharing_core', 0, '1/32', 'expired', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_wastec_customer_id, 1, '2024-08-18', '2025-08-17', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
  ...
  INSERT INTO contracts (customer_id, contract_number, start_date, end_date, core_type, core_total, sharing_ratio, status, billing_every, billing_unit, created_at, updated_at)
  VALUES (v_wastec_customer_id, 'KIMA.BAK-46/DBO/FO/X/2025', '2025-08-18', '2026-08-17', 'sharing_core', 0, '1/32', 'aktif', 1, 'bulan', NOW(), NOW())
  RETURNING id INTO v_contract_id;

  INSERT INTO contract_versions (contract_id, customer_id, version_number, start_date, end_date, core_type, core_total, shared_core_ratio, created_at, updated_at)
  VALUES (v_contract_id, v_wastec_customer_id, 1, '2025-08-18', '2026-08-17', 'sharing_core', 0, '1/32', NOW(), NOW())
  RETURNING id INTO v_version_id;
