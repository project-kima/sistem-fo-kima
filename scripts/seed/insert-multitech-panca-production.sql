-- ============================================================================
-- UPSERT DATA CUSTOMER MULTITECH & PANCA KARSA - PRODUCTION
-- ============================================================================
-- Tanggal: 2026-05-17
-- Database: Supabase PostgreSQL (Production)
-- Cara Pakai: Review, lalu copy-paste script ini ke Supabase SQL Editor dan Run
-- Catatan:
-- - PT Multitech Infomedia dibuat 12 invoice bulanan: Jul 2025 s.d. Jun 2026.
-- - Keterangan Multitech "ditagihkan per3 bulan" disimpan di remarks; invoice tetap bulanan untuk monitoring.
-- - PT Panca Karsa Sejahtera dibuat 2 invoice bulanan: Mar 2026 s.d. Apr 2026 sesuai nilai kontrak 36.000.000.
-- - Keduanya memakai core_type 'core', core_total 4, dan sharing_ratio NULL.
-- ============================================================================
...
BEGIN
  FOR row_data IN
    SELECT *
    FROM (VALUES
      ('PT Multitech Infomedia', 'CUST-MULTITECH-4-CORE', '4 Core', DATE '2025-07-28', DATE '2025-07-28', DATE '2026-07-27', 'core', 4, NULL, 'KIMA.BAK-273A/DOP/FO/VII/2025', '077/FO/8/25', 'lunas', 'ditagihkan per3 bulan', 20000000::numeric, 240000000::numeric, 2500000::numeric, DATE '2025-07-01', DATE '2026-06-01'),
      ('PT Panca Karsa Sejahtera', 'CUST-PANCA-KARSA-4-CORE', '4 Core', DATE '2026-01-14', DATE '2026-03-14', DATE '2026-05-13', 'core', 4, NULL, 'KIMA.BAK-01/DBO/FO/I/2026', '011/FO/1/26', 'lunas', NULL, 18000000::numeric, 36000000::numeric, NULL::numeric, DATE '2026-03-01', DATE '2026-04-01')
  ...
  LOOP
    ...
    IF v_version_id IS NULL THEN
      ...
      VALUES (
        ...
        v_monthly_amount,
        v_yearly_amount,
        COALESCE(row_data.remarks, 'Imported from Multitech Panca spreadsheet batch'),
        NOW(),
        NOW()
      )
...
WHERE c.customer_code IN ('CUST-MULTITECH-4-CORE', 'CUST-PANCA-KARSA-4-CORE')
